...
function getForecast(coordinates) {
  // let apiKey = "6c60fabe649d33c314498b8aba31de6b";
   let spiKey = "b2cb01954630f54d7c3f4c06fe11a8f8";
    ...
    if (index < 5) {
      forecastHTML =
        ...
        <p class="dayX">
          ...
          <img src="imgs/icons/icon_${forecastDay.weather[0].icon}.svg" alt="rain" /><br />
          <span class="dayXtemp_max">${Math.round(forecastDay.temp.max)}°</span>
          <span class="dayXtemp_min">${Math.round(forecastDay.temp.min)}°</span>
        </p>
      </div>
